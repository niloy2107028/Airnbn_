        ...
        <div class="col-lg-8 mx-auto">
            <div class="card listing_card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            @if($listing->image_url)
                                <img src="{{ $listing->image_url }}" alt="{{ $listing->title }}" class="img-fluid rounded">
                            @else
                    ...
                    <!-- Booking Form -->
                    <form action="{{ route('bookings.store', $listing) }}" method="POST" id="bookingForm">
                        @csrf

                        <div class="mb-3">
                            <label for="persons" class="form-label">Number of Guests</label>
                            <input type="number" 
                                   class="form-control @error('persons') is-invalid @enderror" 
                                   id="persons" 
                                   name="persons" 
                                   value="{{ old('persons', 1) }}" 
                                   min="1" 
