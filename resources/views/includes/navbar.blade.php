...
<nav class="navbar">
    ...
    <!-- Mobile er search bar -->
    <div class="mobile-search">
        <form class="mobile-search-bar" action="{{ route('listings.index') }}" method="GET">
            <input class="mobile-search-input" type="search" name="search" placeholder="Search destinations"
    ...
    <!-- Desktop er center e search bar -->
